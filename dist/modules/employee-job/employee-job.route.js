...
// get single data
employeeJobRouter.get("/:id", checkToken_1.checkToken, (0, auth_1.default)(roles_1.ENUM_ROLE.ADMIN, roles_1.ENUM_ROLE.USER), employee_job_controller_1.employeeJobController.getEmployeeJobController);
// update data
employeeJobRouter.patch("/:id", checkToken_1.checkToken, employee_job_controller_1.employeeJobController.updateEmployeeJobController);
// delete data
